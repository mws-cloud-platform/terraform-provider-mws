...
func SecretVersionTestCase(ctx context.Context, sdk *mws.SDK) (acctest.SingleResourceTestCase, error) {
	resourceSDK, err := resourcesdk.NewSecretVersion(ctx, sdk)
	if err != nil {
	...
	return acctest.SingleResourceTestCase{
		...
		ResourceExists: func(ctx context.Context, id string) error {
			r, err := GetSecretVersion(ctx, resourceSDK, id)
			if err != nil {
		...
		ResourceNotExists: func(ctx context.Context, id string) error {
			_, err := GetSecretVersion(ctx, resourceSDK, id)
			if err != nil {
...
func GetSecretVersion(ctx context.Context, sdk *resourcesdk.SecretVersion, id string) (*apimodel.SecretVersionOptionalResponse, error) {
	...
	return sdk.GetSecretVersion(ctx, client.GetSecretVersionRequest{
