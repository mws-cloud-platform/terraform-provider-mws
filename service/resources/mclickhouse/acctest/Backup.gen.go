...
func BackupTestCase(ctx context.Context, sdk *mws.SDK) (acctest.SingleResourceTestCase, error) {
	resourceSDK, err := resourcesdk.NewClickhouseClusterBackup(ctx, sdk)
	if err != nil {
	...
	return acctest.SingleResourceTestCase{
		...
		ResourceExists: func(ctx context.Context, id string) error {
			r, err := GetBackup(ctx, resourceSDK, id)
			if err != nil {
		...
		ResourceNotExists: func(ctx context.Context, id string) error {
			_, err := GetBackup(ctx, resourceSDK, id)
			if err != nil {
...
func GetBackup(ctx context.Context, sdk *resourcesdk.ClickhouseClusterBackup, id string) (*apimodel.ClickhouseBackupOptionalResponse, error) {
	ref, err := mclickhouseref.ParseClickhouseBackupRef(ctx, id)
	if err != nil {
		return nil, fmt.Errorf("parse reference: %w", err)
	}
	return sdk.GetClickhouseClusterBackup(ctx, client.GetClickhouseClusterBackupRequest{
