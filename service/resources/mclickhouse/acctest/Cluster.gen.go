...
func ClusterTestCase(ctx context.Context, sdk *mws.SDK) (acctest.SingleResourceTestCase, error) {
	resourceSDK, err := resourcesdk.NewClickhouseCluster(ctx, sdk)
	if err != nil {
...
func GetCluster(ctx context.Context, sdk *resourcesdk.ClickhouseCluster, id string) (*apimodel.ClickhouseClusterOptionalResponse, error) {
	ref, err := mclickhouseref.ParseClickhouseClusterRef(ctx, id)
	if err != nil {
		return nil, fmt.Errorf("parse reference: %w", err)
	}
	return sdk.GetClickhouseCluster(ctx, client.GetClickhouseClusterRequest{
