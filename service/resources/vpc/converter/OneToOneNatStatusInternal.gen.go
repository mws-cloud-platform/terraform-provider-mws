...
func OneToOneNatStatusInternalAPIResponseToTFModel(ctx context.Context, am *apimodel.OneToOneNatStatusInternalResponse) (*tfmodel.OneToOneNatStatusInternal, tfdiag.Diagnostics) {
	if am == nil {
		return nil, nil
	}
