...
func ExternalAddressTestCase(ctx context.Context, sdk *mws.SDK) (acctest.SingleResourceTestCase, error) {
	resourceSDK, err := resourcesdk.NewExternalAddress(ctx, sdk)
	if err != nil {
	...
	return acctest.SingleResourceTestCase{
		...
		ResourceExists: func(ctx context.Context, id string) error {
			r, err := GetExternalAddress(ctx, resourceSDK, id)
			if err != nil {
		...
		ResourceNotExists: func(ctx context.Context, id string) error {
			_, err := GetExternalAddress(ctx, resourceSDK, id)
			if err != nil {
...
func GetExternalAddress(ctx context.Context, sdk *resourcesdk.ExternalAddress, id string) (*apimodel.ExternalAddressOptionalResponse, error) {
	...
	return sdk.GetExternalAddress(ctx, client.GetExternalAddressRequest{
