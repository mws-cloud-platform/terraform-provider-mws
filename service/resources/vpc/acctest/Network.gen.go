...
func NetworkTestCase(ctx context.Context, sdk *mws.SDK) (acctest.SingleResourceTestCase, error) {
	resourceSDK, err := resourcesdk.NewNetwork(ctx, sdk)
	if err != nil {
	...
	return acctest.SingleResourceTestCase{
		...
		ResourceExists: func(ctx context.Context, id string) error {
			r, err := GetNetwork(ctx, resourceSDK, id)
			if err != nil {
		...
		ResourceNotExists: func(ctx context.Context, id string) error {
			_, err := GetNetwork(ctx, resourceSDK, id)
			if err != nil {
...
func GetNetwork(ctx context.Context, sdk *resourcesdk.Network, id string) (*apimodel.NetworkOptionalResponse, error) {
	...
	return sdk.GetNetwork(ctx, client.GetNetworkRequest{
