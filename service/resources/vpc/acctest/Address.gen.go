...
func AddressTestCase(ctx context.Context, sdk *mws.SDK) (acctest.SingleResourceTestCase, error) {
	resourceSDK, err := resourcesdk.NewAddress(ctx, sdk)
	if err != nil {
	...
	return acctest.SingleResourceTestCase{
		...
		ResourceExists: func(ctx context.Context, id string) error {
			r, err := GetAddress(ctx, resourceSDK, id)
			if err != nil {
		...
		ResourceNotExists: func(ctx context.Context, id string) error {
			_, err := GetAddress(ctx, resourceSDK, id)
			if err != nil {
...
func GetAddress(ctx context.Context, sdk *resourcesdk.Address, id string) (*apimodel.AddressOptionalResponse, error) {
	ref, err := vpcref.ParseAddressRef(ctx, id)
	if err != nil {
		return nil, fmt.Errorf("parse reference: %w", err)
	}
	return sdk.GetAddress(ctx, client.GetAddressRequest{
