...
func OneToOneNatTestCase(ctx context.Context, sdk *mws.SDK) (acctest.SingleResourceTestCase, error) {
	resourceSDK, err := resourcesdk.NewOneToOneNat(ctx, sdk)
	if err != nil {
	...
	return acctest.SingleResourceTestCase{
		...
		ResourceExists: func(ctx context.Context, id string) error {
			r, err := GetOneToOneNat(ctx, resourceSDK, id)
			if err != nil {
		...
		ResourceNotExists: func(ctx context.Context, id string) error {
			_, err := GetOneToOneNat(ctx, resourceSDK, id)
			if err != nil {
...
func GetOneToOneNat(ctx context.Context, sdk *resourcesdk.OneToOneNat, id string) (*apimodel.OneToOneNatOptionalResponse, error) {
	ref, err := vpcref.ParseOneToOneNatRef(ctx, id)
	if err != nil {
		return nil, fmt.Errorf("parse reference: %w", err)
	}
	return sdk.GetOneToOneNat(ctx, client.GetOneToOneNatRequest{
