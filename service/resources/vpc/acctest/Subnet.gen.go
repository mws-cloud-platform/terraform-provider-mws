...
func SubnetTestCase(ctx context.Context, sdk *mws.SDK) (acctest.SingleResourceTestCase, error) {
	resourceSDK, err := resourcesdk.NewSubnet(ctx, sdk)
	if err != nil {
	...
	return acctest.SingleResourceTestCase{
		...
		ResourceExists: func(ctx context.Context, id string) error {
			r, err := GetSubnet(ctx, resourceSDK, id)
			if err != nil {
		...
		ResourceNotExists: func(ctx context.Context, id string) error {
			_, err := GetSubnet(ctx, resourceSDK, id)
			if err != nil {
...
func GetSubnet(ctx context.Context, sdk *resourcesdk.Subnet, id string) (*apimodel.SubnetOptionalResponse, error) {
	ref, err := vpcref.ParseSubnetRef(ctx, id)
	if err != nil {
		return nil, fmt.Errorf("parse reference: %w", err)
	}
	return sdk.GetSubnet(ctx, client.GetSubnetRequest{
