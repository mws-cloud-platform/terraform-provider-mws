...
func BackupTestCase(ctx context.Context, sdk *mws.SDK) (acctest.SingleResourceTestCase, error) {
	resourceSDK, err := resourcesdk.NewPostgresBackup(ctx, sdk)
	if err != nil {
...
func GetBackup(ctx context.Context, sdk *resourcesdk.PostgresBackup, id string) (*apimodel.PostgresBackupResponse, error) {
	ref, err := mpostgresref.ParsePostgresBackupRef(ctx, id)
	if err != nil {
		return nil, fmt.Errorf("parse reference: %w", err)
	}
	return sdk.GetPostgresBackup(ctx, client.GetPostgresBackupRequest{
