...
func PostgresStatusAddressAPIResponseToTFModel(ctx context.Context, am *model.PostgresStatusAddressResponse) (*tfmodel.PostgresStatusAddress, tfdiag.Diagnostics) {
	if am == nil {
		return nil, nil
	}
