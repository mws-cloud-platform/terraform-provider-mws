...
func TopicTestCase(ctx context.Context, sdk *mws.SDK) (acctest.SingleResourceTestCase, error) {
	resourceSDK, err := resourcesdk.NewTopic(ctx, sdk)
	if err != nil {
	...
	return acctest.SingleResourceTestCase{
		...
		ResourceExists: func(ctx context.Context, id string) error {
			r, err := GetTopic(ctx, resourceSDK, id)
			if err != nil {
		...
		ResourceNotExists: func(ctx context.Context, id string) error {
			_, err := GetTopic(ctx, resourceSDK, id)
			if err != nil {
...
func GetTopic(ctx context.Context, sdk *resourcesdk.Topic, id string) (*apimodel.KafkaTopicResponse, error) {
	ref, err := mkafkaref.ParseKafkaTopicRef(ctx, id)
	if err != nil {
		return nil, fmt.Errorf("parse reference: %w", err)
	}
	return sdk.GetKafkaTopic(ctx, client.GetKafkaTopicRequest{
