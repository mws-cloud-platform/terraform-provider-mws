...
func KafkaEndpointBrokerAddressStatusAPIResponseToTFModel(ctx context.Context, am *model.KafkaEndpointBrokerAddressStatusResponse) (*tfmodel.KafkaEndpointBrokerAddressStatus, tfdiag.Diagnostics) {
	if am == nil {
		return nil, nil
	}
