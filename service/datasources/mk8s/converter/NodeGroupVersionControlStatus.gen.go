...
func NodeGroupVersionControlStatusAPIResponseToTFModel(ctx context.Context, am *apimodel.NodeGroupVersionControlStatusResponse) (*tfmodel.NodeGroupVersionControlStatus, tfdiag.Diagnostics) {
	if am == nil {
		return nil, nil
	}

	var diags tfdiag.Diagnostics
	var t tfmodel.NodeGroupVersionControlStatus
	...
	if am.AutoUpdate != nil {
		t.AutoUpdate = types.BoolPointerValue(am.AutoUpdate)
	} else {
