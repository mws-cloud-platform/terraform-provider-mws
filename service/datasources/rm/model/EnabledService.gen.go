...
func (s *EnabledService) GetSchema() schema.Schema {
	return schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"metadata": schema.SingleNestedAttribute{
				Attributes: new(EnabledServiceMetadata).GetSchema().Attributes,
				Computed:   true,
			},
			"status": schema.SingleNestedAttribute{
				Attributes: new(EnabledServiceStatus).GetSchema().Attributes,
				Computed:   true,
			},
			"active": schema.BoolAttribute{
				MarkdownDescription: `Активен ли сервис для проекта`,
				Computed:            true,
			},
		},
	}
...
type EnabledServiceMetadata struct {
	tfcommon.TypedResourceMetadata
	Id types.String `tfsdk:"id"`
}

func (s *EnabledServiceMetadata) GetSchema() schema.Schema {
	return schema.Schema{
		MarkdownDescription: `Представление поля Metadata анонимного типа структуры EnabledService`,
		Attributes: map[string]schema.Attribute{
