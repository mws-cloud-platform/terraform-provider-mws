...
func OneToOneNatStatusInternalAPIResponseToTFModel(ctx context.Context, am *model.OneToOneNatStatusInternalResponse) (*tfmodel.OneToOneNatStatusInternal, tfdiag.Diagnostics) {
	if am == nil {
		return nil, nil
	}
