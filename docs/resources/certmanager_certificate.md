...
- `challenges_deadline` (String) Крайний срок настройки делегации для прохождения проверки прав на домены.
...
Дата в формате RFC3339. Пример: 2006-01-02T15:04:05Z07:00
- `renewal_status` (String) Статус обновления сертификата
