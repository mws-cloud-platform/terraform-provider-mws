...
// Source: go/pkg/internal/imds/client.go
//
// Generated by this command:
//
//	mockgen -typed -package mocks -source=go/pkg/internal/imds/client.go -destination go/pkg/internal/imds/mocks/mockclient.go
//
